...
//a viewmodel basically stores the state of the view it is working on . the view is basically dumb and it only needs to present things. the viewmodel is responsible for the tast and the changes inside the view
